...
Next.js 16 (App Router, SSR) версия витрины **server-shop-sale-ui**
(sale-server.ru, скин МВГ Групп). Полная миграция с сохранением дизайна 1:1
по рецепту `server-shop-sp-next` (см. его docs/MIGRATION-LOG.md — журнал
пилота со всеми уроками).
