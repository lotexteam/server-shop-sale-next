#!/usr/bin/env bash
# Единая точка деплоя server-shop-sale-next + миграция со старой Vite-витрины.
#
...
#
# Миграция с server-shop-sale-ui (Vite SPA) — один клик:
#   ./scripts/update.sh --migrate                    # авто-поиск ../server-shop-sale-ui
